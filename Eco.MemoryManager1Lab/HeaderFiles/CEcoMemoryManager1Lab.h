...
typedef struct EcoMemoryBlock_623E1838 EcoMemoryBlock_623E1838;
typedef struct EcoMemoryBlock_623E1838* EcoMemoryBlock_623E1838Ptr;

struct EcoMemoryBlock_623E1838 { // Блок данных
    uint32_t size;
    uint8_t is_free;
    EcoMemoryBlock_623E1838Ptr next;  
    EcoMemoryBlock_623E1838Ptr prev; 
};
...
typedef struct CEcoMemoryManager1Lab_623E1838 {
    ...
    EcoMemoryBlock_623E1838Ptr m_pFirstBlock; 
    EcoMemoryBlock_623E1838Ptr m_pFreeList;  // Список свободных блоков
    uint32_t m_iTotalAllocated;
    uint32_t m_iTotalFreed;                  // Всего освобождено байт
    uint32_t m_iMaxAllocated;     
