...
typedef struct CEcoLab1Sink {
	...
	int16_t (ECOCALLMETHOD *PrintArray)(/* in */ struct CEcoLab1Sink* me, /* in */ int32_t* basic_array, uint32_t length);
	int16_t (ECOCALLMETHOD *AddStep)(/* in */ struct CEcoLab1Sink* me);
