 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_PrintArray(/* in */ struct IEcoLab1Events* me, /* in */ int32_t* basic_array, uint32_t length) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
	int32_t i = 0;
...
int16_t ECOCALLMETHOD CEcoLab1Sink_AddStep(/* in */ struct IEcoLab1Events* me) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
	int32_t i = 0;
...
IEcoLab1VTblEvents g_x2D2E3B9214F248A6A09ECB494B59C795VTblEvents = {
    ...
    CEcoLab1Sink_PrintArray,
	CEcoLab1Sink_AddStep
};
...
int16_t ECOCALLMETHOD createCEcoLab1Sink(/* in */ IEcoMemoryAllocator1* pIMem, /* out */ IEcoLab1Events** ppIEcoLab1Events) {
	...
	/* Установка счетчика шагов на компонент */
	pCMe->m_iStep = 0;
