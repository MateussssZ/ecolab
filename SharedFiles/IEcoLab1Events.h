...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events */
    int16_t (ECOCALLMETHOD *PrintArray)(/* in */ struct IEcoLab1Events* me, /* in */ int32_t* basic_array, uint32_t length);
	int16_t (ECOCALLMETHOD *AddStep)(/* in */ struct IEcoLab1Events* me);
